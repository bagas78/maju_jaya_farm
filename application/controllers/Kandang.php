...
class Kandang extends CI_Controller{
	...
	function histori($id){
		...
		//data
		$data['data'] = $this->query_builder->view("SELECT a.kandang_log_id as id, b.barang_nama AS barang, a.kandang_log_jumlah AS jumlah, a.kandang_log_tanggal AS tanggal FROM t_kandang_log AS a JOIN t_barang AS b ON a.kandang_log_barang = b.barang_id WHERE a.kandang_log_hapus = 0 AND a.kandang_log_kandang = '$id'");
